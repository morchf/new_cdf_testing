...
# @pytest.mark.skip
def test_create_vps():
    if os.path.exists(os.path.join(sys.path[0], "testdata/CreateVPSEndToEndAuto.json")):
        with open(
            os.path.join(sys.path[0], "testdata/CreateVPSEndToEndAuto.json")
        ) as f:
            data = json.load(f)
...
def test_create_vps_customer_blank():
    if os.path.exists(os.path.join(sys.path[0], "testdata/CreateCustomerBlank.json")):
        with open(os.path.join(sys.path[0], "testdata/CreateCustomerBlank.json")) as f:
            data = json.load(f)
            data_json_str = json.dumps(data)
            f.close()
    url = conftest.VPS_URL + "/vps"
...
def test_create_vps_zero():
    if os.path.exists(os.path.join(sys.path[0], "testdata/CreateVPSNumberZero.json")):
        with open(os.path.join(sys.path[0], "testdata/CreateVPSNumberZero.json")) as f:
            data = json.load(f)
            data_json_str = json.dumps(data)
            f.close()
    url = conftest.VPS_URL + "/vps"
...
def test_update_vps():
    if os.path.exists(os.path.join(sys.path[0], "testdata/UpdateVPSEndToEnd.json")):
        with open(os.path.join(sys.path[0], "testdata/UpdateVPSEndToEnd.json")) as f:
            data = json.load(f)
            data_json_str = json.dumps(data)
            f.close()
    url = conftest.VPS_URL + "/vps"
...
def test_delete():
    if os.path.exists(os.path.join(sys.path[0], "testdata/DeleteVPSEndToEnd.json")):
        with open(os.path.join(sys.path[0], "testdata/DeleteVPSEndToEnd.json")) as f:
            data = json.load(f)
            data_json_str = json.dumps(data)
            f.close()
    url = conftest.VPS_URL + "/vps"
