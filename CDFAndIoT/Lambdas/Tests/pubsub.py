# https://github.com/AndrewLeeSmith/Website/blob/master/aws-iot-python-mqtt/env_sensor_1.py
# http://www.andrewleesmith.co.uk/2020/04/07/connecting-to-aws-iot-core-using-python-and-mqtt/
