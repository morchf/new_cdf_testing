...
cert_filename = config_mqtt.cert_filename
key_filename = config_mqtt.key_filename
cafile_filename = config_mqtt.cafile_filename
logging = config_mqtt.logging
client_id = config_mqtt.client_id
endpoint = config_mqtt.endpoint
...
def main():
    ...
    # Connect to IoT Core
    mqtt_client = MQTTClient(logging=logging)
