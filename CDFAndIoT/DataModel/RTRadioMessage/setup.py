...
namespace_package = "gtt.data_model.rt_radio_message"
package_name = "rt-radio-message-data-model"
...
setup(
    name=package_name,
    python_requires=">=3.8",
    description="Data Model with pydantic classes for RTRadioMessage data",
