...
# This file is part of gtt.data_model.intersection
...
namespace_package = "gtt.data_model.intersection"
package_name = "gtt_data_model_intersection"
...
setup(
    ...
    version="0.1.0",
    python_requires=">=3.8",
    description="Intersection models",
