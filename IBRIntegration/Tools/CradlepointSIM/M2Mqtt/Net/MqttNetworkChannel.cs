...
namespace uPLibrary.Networking.M2Mqtt
{
   ...
   public class MqttNetworkChannel : IMqttNetworkChannel
   {
      ...
      public void Connect()
      {
         uint protocol = 4032; // tls1.2 ! tls1.1 ! tls1.0 = 0xC00 | 0x300 | 0xC0 = 4032
#if (MF_FRAMEWORK_VERSION_V4_2 || MF_FRAMEWORK_VERSION_V4_3)
         protocol = (uint)SslProtocols.TLSv1;
#endif
         ...
         if (secure)
         {
            ...
            this.sslStream = new SslStream(this.netStream, false, this.userCertificateValidationCallback, this.userCertificateSelectionCallback);
                ...
                this.sslStream.AuthenticateAsClient(this.remoteHostName,
                    ...
                    (SslProtocols)protocol,  //SslProtocols.TLSv1);
#else
                    this.sslStream.AuthenticateAsClient(
                      this.remoteHostName,
                      null,
                   // new X509CertificateCollection(new X509Certificate[] { caCert }),
