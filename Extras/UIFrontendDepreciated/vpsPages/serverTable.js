  ...
  constructor(props) {
    ...
    this.serverdata.forEach((vpss) => {
      if (typeof vpss.dockerStatus == 'undefined') {
        ...
        vpss.dockerStatus =
          vpss.dockerStatus.charAt(0).toUpperCase() +
          vpss.dockerStatus.slice(1).toLowerCase();
      }
      vpss.deviceStatus =
        vpss.deviceStatus.charAt(0).toUpperCase() +
        vpss.deviceStatus.slice(1).toLowerCase();
    });
