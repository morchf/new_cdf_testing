CREATE
OR REPLACE PROCEDURE testing.sp_fixture__dwell_time__cvp_logs () AS $$ BEGIN
...
FROM
  's3://gtt-gd-artifacts-dev/dwh/sql/test/data/cvp_logs.csv' iam_role 'arn:aws:iam::083011521439:role/AWSDataWarehouseRole-dev' CSV IGNOREHEADER 1 FILLRECORD;
